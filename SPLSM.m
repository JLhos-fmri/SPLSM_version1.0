...
% Updata on 17 Mar. 2023: 
% Change Software name to Standard sPace Lesion-Symptom Mapping, SPLSM
% Qiang Xu, 
...
clear all;
close all;
uiwait(msgbox({'Standard sPace Lesion-Symptom Mapping(SPLSM)',...
    'Developed by Department of Radiology, Jinling hospital, Medical School, Nanjing University',...
    'If you have any comments or suggestion, please contract fmrixuq@126.com'}));
disp('Standard sPace Lesion-Symptome Mapping(SPLSM)!')
disp('Developed by Department of Radiology, Jinling hospital, Medical School, Nanjing University')
disp('If you have any comments or suggestion, please contract fmrixuq@126.com')
H.fig = figure('unit','norm',...
    'pos',[0.3,0.3,0.4,0.4],...
    'menubar','none',...
    'color','w',...
    'name','Standard sPace Lesion-Symptom Mapping(SPLSM)');
